...
DEF_string(key, "/home/titto/CProjects/cocoyaxi/test/so/client.key", "private key file");
DEF_string(ca, "/home/titto/CProjects/cocoyaxi/test/so/client.crt", "certificate file");
DEF_int32(t, 1, "0: server & client, 1: server, 2: client");
